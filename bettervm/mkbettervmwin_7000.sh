...
echo FAIR WARNING: the installiation will take an hout or so because the download link is from archive.org.
...
~/bettervm/mkcvm.sh
cd ~/Downloads
curl -0 https://archive.org/download/build-7000-x-64/Build_7000_X64.ISO --output 7.iso
